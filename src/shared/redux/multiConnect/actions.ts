...
export function addInstance(instanceKey: number, initialState: any, keyPathToState: string[]): IAddInstance {
  return {
...
export function removeInstance(instanceKey: number, keyPathToState: string[]): IRemoveInstance {
  return {
